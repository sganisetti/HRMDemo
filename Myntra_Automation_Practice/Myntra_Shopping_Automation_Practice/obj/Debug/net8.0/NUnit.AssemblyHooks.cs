...
public class Myntra_Shopping_Automation_Practice_NUnitAssemblyHooks
{
    [global::NUnit.Framework.OneTimeSetUp]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public async Task AssemblyInitializeAsync()
    {
        var currentAssembly = typeof(Myntra_Shopping_Automation_Practice_NUnitAssemblyHooks).Assembly;
